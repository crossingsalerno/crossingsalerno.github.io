...
const translations = {
  it: {
    ...
    r1t: "Transfer privato",
    r1p: "Transfer privato da/per Aeroporto di Napoli Capodichino, da/per Aeroporto Salerno Costa d’Amalfi e da/per Stazione di Napoli Centrale.",
    ...
    r9p: "Possibilità di organizzare la colazione presso un bar convenzionato adiacente alla struttura.",
    ...
    r11t: "Convenzioni con ristoranti e pizzerie",
    ...
    territoryKicker: "Il territorio",
    territoryTitle: "Tra storia, mare e paesaggi senza tempo.",
...
vietriText: "Vietri sul Mare racconta la sua identità attraverso maioliche, botteghe artigiane, cupole colorate e terrazze affacciate sul Mediterraneo. Un borgo vivace, elegante e profondamente legato alla tradizione ceramica campana.",
  ...
  en: {
    ...
    r1t: "Private transfers",
    r1p: "Private transfer from/to Naples Capodichino Airport, from/to Salerno Costa d’Amalfi Airport, and from/to Napoli Centrale Station.",
    r2t: "Ferry tickets",
    ...
    r9p: "Breakfast can be arranged at a partner café ajacent to the property.",
    r10t: "Beach booking",
    r10p: "Assistance with booking a parasol and sun loungers at local beach clubs, subject to availability.",
    r11t: "Partner restaurants and pizzerias",
